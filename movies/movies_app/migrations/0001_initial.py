    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies.actordirector', verbose_name='Актеры')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.actordirector', verbose_name='Режиссеры')),
